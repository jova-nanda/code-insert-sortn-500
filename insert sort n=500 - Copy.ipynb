...
def percobaan_insertion_sort(jumlah_percobaan=1, n=500, range_nilai=(1, 1000), tampilkan_langkah=True):
    ...
    for percobaan in range(1, jumlah_percobaan + 1):
        ...
        # Agar tidak memenuhi layar, data awal hanya ditampilkan sebagian jika n besar
        if n <= 20:
...
if __name__ == "__main__":
    # tampilkan_langkah=False agar output tidak banjir
    # Jika ingin melihat proses per langkah, ubah menjadi True (disarankan n kecil, misal n=10)
